<template>
  <n-card title="Card" closable @close="handleClose">
    <template #header>
      <n-page-header title="Create new a Module" subtitle="A podcast to improve designs" @back="handleBack">
        <!-- <template #title>
          Create new a Module
        </template> -->
        <template #avatar>
    ...
    <n-space vertical>
      ...
      <n-space>
        <n-button-group>
          <n-button @click="prev">
            <template #icon>
              <NaiveIcon name="uil:arrow-left"/>
            </template>
          </n-button>
          <n-button @click="next">
            <template #icon>
              <NaiveIcon name="uil:arrow-right"/>
            </template>
          </n-button>
        </n-button-group>
